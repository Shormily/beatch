...
export default function DestinationSlider() {
  ...
  return (
    <section className="py-12 bg-slate-50">
      {/* ✅ Local CSS (scoped with .my-dest-swiper) */}
      <style>{`
        .my-dest-swiper .swiper-pagination-bullet {
        ...
        .my-dest-swiper .swiper-pagination-bullet-active {
      ...
      <div className="max-w-[1240px] mx-auto px-8">
        ...
        <div className="relative">
          <Swiper
            ...
            /* If you want bullets here too, add:
               pagination={{ clickable: true }}
               and import Pagination module + css */
          >
            {destinations.map((dest) => (
              <SwiperSlide key={dest.id}>
                <div className="relative h-[430px] w-full rounded-2xl overflow-hidden shadow-lg group">
                  <img
                    src={dest.image}
                    alt={dest.name}
