...
export default function HotelForm() {
  return (
    <div className="p-6 relative">
      <div className="flex flex-col lg:flex-row gap-4 mt-4 py-5">
        {/* Destination */}
        <div className="flex-1 min-w-[250px] h-20 border border-gray-300 rounded-md px-4 pt-2 pb-1 flex flex-col justify-between">
          <span className="text-[12px] text-gray-500">Destination</span>
          <input
            type="text"
            placeholder="Enter city or hotel"
            className="outline-none bg-transparent font-normal placeholder-gray-500 pb-4"
          />
        </div>
        ...
        <div className="w-full lg:w-auto flex justify-center lg:justify-end">
          <button
            className="w-full lg:w-24 h-20 rounded-md bg-red-700 hover:bg-red-500 text-white flex items-center justify-center"
            title="Search"
          >
            <CiSearch size={40} />
          </button>
